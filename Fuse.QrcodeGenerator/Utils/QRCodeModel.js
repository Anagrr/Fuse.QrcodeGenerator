...
// TODO: all from below move to separate classes
...
export default class QRCodeModel {
    ...
    createData(typeNumber, errorCorrectLevel, dataList) {
        var rsBlocks = new QRRSBlock(0, 0).getRSBlocks(typeNumber, errorCorrectLevel);
    ...
    createBytes(buffer, rsBlocks) {
        ...
        for (var r = 0; r < rsBlocks.length; r++) {
            ...
            maxEcCount = Math.max(maxEcCount, ecCount); dcdata[r] = new Array(dcCount);
